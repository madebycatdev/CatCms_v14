...
namespace EuroCMS.FrontEnd.com.euromsg.post {
    using System;
    ...
    public partial class Post : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback PostTransactionalEmailWithXsltTemplate2OperationCompleted;
        ...
        private System.Threading.SendOrPostCallback GetPostBulkResultWithCustomParamsOperationCompleted;
        ...
        /// <remarks/>
        public Post() {
            this.Url = global::EuroCMS.FrontEnd.Properties.Settings.Default.EuroCMS_FrontEnd_com_euromsg_post_Post;
        ...
        /// <remarks/>
        public event PostTransactionalEmailWithXsltTemplate2CompletedEventHandler PostTransactionalEmailWithXsltTemplate2Completed;
        ...
        /// <remarks/>
        public event GetPostBulkResultWithCustomParamsCompletedEventHandler GetPostBulkResultWithCustomParamsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://ws.euromsg.com/post/PostTransactionalEmailWithXsltTemplate2", RequestNamespace="http://ws.euromsg.com/post", ResponseNamespace="http://ws.euromsg.com/post", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public EmPostResult PostTransactionalEmailWithXsltTemplate2(string ServiceTicket, string FromName, string FromAddress, string ReplyAddress, string TemplateName, string Xml, string Charset, string ToName, string ToEmailAddress, EmAttachment[] Attachments) {
            object[] results = this.Invoke("PostTransactionalEmailWithXsltTemplate2", new object[] {
                        ServiceTicket,
                        FromName,
                        FromAddress,
                        ReplyAddress,
        ...
        /// <remarks/>
        public void PostTransactionalEmailWithXsltTemplate2Async(string ServiceTicket, string FromName, string FromAddress, string ReplyAddress, string TemplateName, string Xml, string Charset, string ToName, string ToEmailAddress, EmAttachment[] Attachments) {
            this.PostTransactionalEmailWithXsltTemplate2Async(ServiceTicket, FromName, FromAddress, ReplyAddress, TemplateName, Xml, Charset, ToName, ToEmailAddress, Attachments, null);
        }
        
        /// <remarks/>
        public void PostTransactionalEmailWithXsltTemplate2Async(string ServiceTicket, string FromName, string FromAddress, string ReplyAddress, string TemplateName, string Xml, string Charset, string ToName, string ToEmailAddress, EmAttachment[] Attachments, object userState) {
            if ((this.PostTransactionalEmailWithXsltTemplate2OperationCompleted == null)) {
                this.PostTransactionalEmailWithXsltTemplate2OperationCompleted = new System.Threading.SendOrPostCallback(this.OnPostTransactionalEmailWithXsltTemplate2OperationCompleted);
            }
            this.InvokeAsync("PostTransactionalEmailWithXsltTemplate2", new object[] {
                        ServiceTicket,
                        FromName,
                        FromAddress,
                        ReplyAddress,
                        ...
                        ToName,
                        ToEmailAddress,
                        Attachments}, this.PostTransactionalEmailWithXsltTemplate2OperationCompleted, userState);
        }
        
        private void OnPostTransactionalEmailWithXsltTemplate2OperationCompleted(object arg) {
            if ((this.PostTransactionalEmailWithXsltTemplate2Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.PostTransactionalEmailWithXsltTemplate2Completed(this, new PostTransactionalEmailWithXsltTemplate2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://ws.euromsg.com/post/GetPostBulkResultWithCustomParams", RequestNamespace="http://ws.euromsg.com/post", ResponseNamespace="http://ws.euromsg.com/post", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public EmPostResult GetPostBulkResultWithCustomParams(string serviceTicket, string beginDateStr, string endDateStr, string customParams, out EmPostBulkReport[] bulkReports) {
            object[] results = this.Invoke("GetPostBulkResultWithCustomParams", new object[] {
                        serviceTicket,
                        beginDateStr,
                        endDateStr,
                        customParams});
            bulkReports = ((EmPostBulkReport[])(results[1]));
            return ((EmPostResult)(results[0]));
        }
        
        /// <remarks/>
        public void GetPostBulkResultWithCustomParamsAsync(string serviceTicket, string beginDateStr, string endDateStr, string customParams) {
            this.GetPostBulkResultWithCustomParamsAsync(serviceTicket, beginDateStr, endDateStr, customParams, null);
        }
        
        /// <remarks/>
        public void GetPostBulkResultWithCustomParamsAsync(string serviceTicket, string beginDateStr, string endDateStr, string customParams, object userState) {
            if ((this.GetPostBulkResultWithCustomParamsOperationCompleted == null)) {
                this.GetPostBulkResultWithCustomParamsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetPostBulkResultWithCustomParamsOperationCompleted);
            }
            this.InvokeAsync("GetPostBulkResultWithCustomParams", new object[] {
                        serviceTicket,
                        beginDateStr,
                        endDateStr,
                        customParams}, this.GetPostBulkResultWithCustomParamsOperationCompleted, userState);
        }
        
        private void OnGetPostBulkResultWithCustomParamsOperationCompleted(object arg) {
            if ((this.GetPostBulkResultWithCustomParamsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetPostBulkResultWithCustomParamsCompleted(this, new GetPostBulkResultWithCustomParamsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2046.0")]
    public delegate void PostTransactionalEmailWithXsltTemplate2CompletedEventHandler(object sender, PostTransactionalEmailWithXsltTemplate2CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2046.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class PostTransactionalEmailWithXsltTemplate2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal PostTransactionalEmailWithXsltTemplate2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2046.0")]
    public delegate void GetPostBulkResultWithCustomParamsCompletedEventHandler(object sender, GetPostBulkResultWithCustomParamsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2046.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetPostBulkResultWithCustomParamsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetPostBulkResultWithCustomParamsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        ...
        /// <remarks/>
        public EmPostBulkReport[] bulkReports {
            get {
                this.RaiseExceptionIfNecessary();
                return ((EmPostBulkReport[])(this.results[1]));
            }
